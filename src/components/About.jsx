...
const About = () => {
    return (
        <div>
            ...
            {/* {Company Stats} */}
            <div className='px-4 lg:px-14 max-w-screen-2xl mx-auto bg-neutralWhite py-16'>
                    ...
                    <div className='md:w-1/2 mx-auto flex sm:flex-row flex-col sm:items-center justify-around gap-12'>
                        <div className='space-y-8'>
                            <div className='flex items-center gap-4'>
                                <img src="/src/assets/icons/Icon-s1.png" alt="" />
                                <div>
                            ...
                            <div className='flex items-center gap-4'>
                                <img src="/src/assets/icons/Icon-s2.png" alt="" />
                                <div>
                        ...
                        <div className='space-y-8'>
                            <div className='flex items-center gap-4'>
                                <img src="/src/assets/icons/Icon-s3.png" alt="" />
                                <div>
                            ...
                            <div className='flex items-center gap-4'>
                                <img src="/src/assets/icons/Icon-s4.png" alt="" />
                                <div>
